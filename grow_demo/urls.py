...
urlpatterns = [
    ...
    path('admin-dashboard/run-payouts/', wallet_views.run_daily_payouts_view, name='run_daily_payouts'),
    path('admin-dashboard/deposits/', wallet_views.admin_deposits, name='wallet_admin_deposits'),
    path('admin-dashboard/investments/', wallet_views.admin_investments, name='wallet_admin_investments'),
